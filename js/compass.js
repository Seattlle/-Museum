(function() {
	...
	// info popup elements, pus buttons that open popups  弹框
...
//	var btnsPopup = document.querySelectorAll(".btn-popup");
	...
	//var btnNightmode = document.getElementById("btn-nightmode");//背景亮度
	...
	// browser agnostic orientation 浏览器方向
	...
	// browser agnostic orientation unlock 浏览器锁屏方向
	...
	// browser agnostic document.fullscreenElement 浏览器全屏
	...
	// browser agnostic document.documentElement.requestFullscreen 启动全屏模式
	...
	// browser agnostic document.documentElement.exitFullscreen 浏览器退出全屏
	...
	function onHeadingChange(event) {
		...
		if (typeof heading !== "undefined" && heading !== null) { // && typeof orientation !== "undefined") {
			...
			positionCurrent.hng=360-positionCurrent.hng;

			if(positionCurrent.hng==0||positionCurrent.hng==360){
				return false;
			}
